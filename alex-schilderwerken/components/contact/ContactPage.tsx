              ...
              <div>
                ...
                <div className="space-y-5">
                  ...
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 bg-primary/20 border border-primary/30 rounded-sm flex items-center justify-center text-accent flex-shrink-0">
                    ...
                    <div>
                      ...
                      <p className="text-muted text-sm">Volgt binnenkort</p>
                    </div>
                  </div>
                </div>
              </div>
