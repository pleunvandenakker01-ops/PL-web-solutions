            ...
            <ul className="space-y-4">
              ...
              <li>
                <div className="flex items-center gap-3 text-muted text-sm">
                  <div className="w-8 h-8 bg-primary/15 border border-primary/25 rounded-sm flex items-center justify-center text-accent/60 flex-shrink-0">
